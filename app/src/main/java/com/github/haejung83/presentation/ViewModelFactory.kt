...
import com.github.haejung83.presentation.frequently.FrequentlyViewModel
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T =
        with(modelClass) {
            when {
                ...
                isAssignableFrom(FrequentlyViewModel::class.java) -> FrequentlyViewModel(lotteryRepository)
